...
html"""
<p style="font-size:20px;">Rianna Thomas (rnt35) </br>
...
# ╔═╡ b4af5762-35ed-430e-a1fe-654a37cd129f
begin
...
# ╔═╡ 63fb0c7f-10ee-46a5-9431-9da754a359c6
html"""
<p style="font-size:20px;">Part A </br>
</p>
"""

# ╔═╡ 5338451e-3c4b-4030-bbbb-42eaf4209a89
begin
	# fill me # Setup a collection of reaction strings -
	reaction_array = Array{String,1}()

	species_array = String["Carbamoyl Phosphate","Citrulline","Argininosuccinate","Fumarate","Arginine","Urea","Ornithine","Aspartate"]
	...
	push!(reaction_array,"v₃,Arginine,Urea+Ornithine,false")
	...
	push!(reaction_array,"b5,∅,Citrulline,false")
	push!(reaction_array,"b6,Arginine,∅,true")
	push!(reaction_array,"b7,Ornithine,∅,true")
...
# ╔═╡ 29809154-71e4-4e81-b418-b1985f993269
(ℳ,ℛ) = size(S)

# ╔═╡ 2371828e-02be-421f-928f-ffca299668c9
species_array

# ╔═╡ d13d2769-17e0-4b9b-b8f2-9450a502b8fb
S

# ╔═╡ b8f33dfd-ad28-4d31-a354-91ab62e73ae7
...
# ╔═╡ 69286152-9577-4ef0-803d-187a063c6811
html"""
<p style="font-size:20px;">Part B </br>
</p>
"""

# ╔═╡ f5fb2b0b-2f4e-4e36-9213-b4690100699c
html"""
<p style="font-size:20px;">6 rows of P = 6 extreame pathways </br>
v3 and b4 contain urea, 4 extreame pathways contain urea </br>
frequency: sum of column/# of pathways </br>
v1: 3/6 = 1/2 </br>
v2: 3/6 = 1/2 </br>
v3: 6/6 = 1</br>
v4: 3/6 = 1/2</br>
...
# ╔═╡ b7fccbe4-c5bf-4b49-ad8a-691a6e78de31
html"""
<p style="font-size:20px;">Part C </br>
</p>
"""

# ╔═╡ 743cb442-b442-483a-a62e-492ae0add9d3
html"""
<p style="font-size:20px;">ranking: Arginine & Citrulline, Ornithine, Argininosuccinate & Aspartate & Carbamoyl Phosphate & Fumarate & Urea  </br>
</p>
"""
...
# ╔═╡ bf3cc0b6-fc20-4de8-b39a-7da2c3499325
html"""
<p style="font-size:20px;">ranking: v1 & v2 & v3 & v4, v5, b1 & b2 & b3 & b4 & b5 & b6 & b7 </br>
</p>
"""

# ╔═╡ 784a6ecc-5d02-4713-b258-74be6911cb82
html"""
<p style="font-size:20px;"> v3,  b4, and b5 had the highest frequency while all v reactions had the most connectivity. There is not a correlation between frequency and connectivity. </br>
</p>
"""
...
# ╔═╡ bcd0d2eb-d7c3-42d1-825e-d68546fab041
𝒩

# ╔═╡ 2ea87ed9-997c-4211-a45a-ff0f53ac82d5
P
...
# ╔═╡ f132793c-2b27-4d9e-8b42-d095e5a4bc4d
diag(MCA)
...
# ╔═╡ f5e023f1-c972-4702-be1d-6c4eeec6106f
diag(RCA)
